...
import com.datasrc.config.JsonSerializer;
...
public class StringValueKafkaProducer {
    private static final Logger log = LoggerFactory.getLogger(StringValueKafkaProducer.class);
    private final KafkaProducer<Long, StringValue> kafkaProducer;

    public static final String TOPIC_NAME = "MyTopic";

    public StringValueKafkaProducer(String bootstrapServers) {
        Properties props = new Properties();
        props.put(CLIENT_ID_CONFIG, "stringValueKafkaProducer");
    ...
    public KafkaProducer<Long, StringValue> getKafkaProducer() {
