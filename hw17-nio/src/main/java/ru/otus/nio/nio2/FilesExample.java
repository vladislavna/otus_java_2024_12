...
public class FilesExample {
    ...
    private void copy() throws IOException, URISyntaxException {
        ...
        var destination = Paths.get("hw17-nio/tmp/share.xml");
    ...
    private void write() throws IOException {
        ...
        Files.write(Paths.get("hw17-nio/tmp/newFile.txt"), testString.getBytes());
    }

    private void walk() {
        try (Stream<Path> paths = Files.walk(Paths.get("hw17-nio"))) {
